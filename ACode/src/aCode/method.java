...
public class method {
	//Here, Static means that to use this main method; u don't have to create an object for the class
	//Here, public means that this is a method that can be accessed even outside the class
	// if the method was private then the method would not be accessible outside the class
	...
	static int avg(int num1, int num2)     // if we remove static from here then the above  avg method call in main method wont work
	{
		int sum = num1+num2;
		return sum/2;
	}
